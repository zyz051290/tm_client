...
function selectRadio(i){
    if(i==1){
        window.location.href='#/godown_keeper/service_uninspected';
    }
    if(i==2){
        window.location.href='#/godown_keeper/service_inspected';
    }
    if(i==3){
        window.location.href='#/godown_keeper/service_hanging';
    }
}